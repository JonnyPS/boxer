...
function animation() {
  ...
  $( document ).mousedown(function() {
    ...
    $( 'body' ).append("<div id='container'><div id='bgLayer'></div><div id='recordedData'><p id='recordedWidth'>Width: </p><p id='recordedHeight'>Height: </p><p id='recordedAspectRatio'>Aspect Ratio: </p><p id='closeBtn' style='margin: 0px; font-family: arial; font-weight: bold; font-size: 11px;'>Click to Close Extension</p></div></div>");
    ...
    $( this ).mousemove(function() {
      ...
      if ( boxWidth || boxHeight == 0 ) {
          aspectRatio = 0;
          console.log('aspectRatio (0) = ' + aspectRatio);
