...
function animation() {
  ...
  $( document ).mousedown(function() {
    ...
    $( 'body' ).append("<div id='container'><div id='recordedData'><p id='recordedWidth'>Width: </p><p id='recordedHeight'>Height: </p><p id='aspectRatio'>Aspect Ratio: </p></div></div>");
    ...
    $( '#recordedData' ).css({position:'fixed', top:0, left: 0, zIndex:'9999999', padding:10, width:'100', backgroundColor: 'rgba(255,255,255,1)'});
    $( '#container' ).css({position:'fixed', top:0, left: 0, zIndex:'9999998', width:'100%', height:'100%', backgroundColor: 'rgba(0,0,0,0.5)'});
    ...
    $( this ).mousemove(function() {
      ...
      if ( boxWidth || boxHeight != 0 ) {
          aspectRatio = Math.round( ( boxWidth / boxHeight ) );
