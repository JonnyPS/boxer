...
function animation() {
  ...
  $( document ).mousedown(function() {
    ...
    $( 'body' ).append("<div id='container'><div id='bgLayer'></div><div id='recordedData'><p id='recordedWidth'>Width: </p><p id='recordedHeight'>Height: </p><p id='aspectRatio'>Aspect Ratio: </p></div></div>");
    ...
    $( '#recordedData' ).css({position:'fixed', top:0, left: 0, zIndex:'9999999', padding:10, width:'120', backgroundColor: 'rgba(255,255,255,1)'});
